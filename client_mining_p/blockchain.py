...
class Blockchain(object):
    ...
    def new_block(self, proof, previous_hash=None):
        ...
        * The hash of the previous block
        ...
        block = {
            ...
            'proof': proof, #being passed 
            'previous_hash': previous_hash #being passed 
        }
    ...
    def hash(self, block):
        ...
        string_object = json.dumps(block, sort_keys=True).encode()
         # sort_keys=True guaranteed to get sorted list of keys
        # TODO: Hash this string using sha256

        raw_hash = hashlib.sha256(string_object)
        hex_hash = raw_hash.hexdigest()
        #hexdigest reformats as hexadecimal
